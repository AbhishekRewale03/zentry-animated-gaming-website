...
const BentoTilt = ({ children, className = '' }) => {
    ...
    // Function executed when the mouse leaves the card
    const handleMouseLeave = () => {
        setTransformStyle(''); // This should clear the transform, but the syntax looks like setTransformStyle('')
    }
        ...
        <section className='bg-black pb-52'>
            <div className='container mx-auto px-3 md:px-10'>
                ...
                <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                    ...
                    <BentoTilt className='bento-tilt_1 col-span-1 me-14 md:col-span-1 md:me-0 '>
                        <BentoCard
